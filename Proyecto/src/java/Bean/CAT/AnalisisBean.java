...
public class AnalisisBean {
    ...
    private RecuperacionInformacion RI;
     ...
     */
    public AnalisisBean() throws IOException {
...
public void analizarTest() throws IOException, ClassNotFoundException{
       ...
       metricasRI= new ArrayList<>();
        ...
        for (int i =1; i <= 2; i++) {
          RI = new RecuperacionInformacion(idTest, i-1, relatos[i-1]);
          RI.analizarRI();
     ...
     //fin del for final   
       ...
       // indexamos los relatos pertenecientes al test( todos los test) 
        ...
        indexarTerminosTest();
         ...
         fc.getExternalContext().redirect("/Proyecto/faces/resultadoAnalisis.xhtml?rutExaminado="+rutExaminado+"&idTest="+idTest);//redirecciona la página
